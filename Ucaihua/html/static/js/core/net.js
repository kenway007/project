...
define("core/net", [ "./lang", "./event" ], function(require, exports) {
    "use strict";


    var _ = require("./lang"), Promise = require("./event").Promise, id = 0, slice = Array.prototype.slice, defaults = {
        type: "get",
        dataType: "json",
        async: true,
        timeout: 0,
    ...
    jsonp = exports.jsonp = function() {
        var options = createOptions(arguments), xhr = {
            id: ++id
        }, callbackName = "baidu_jsonp_" + xhr.id, script = document.createElement("script"), settings = xhr.ajaxSettings = _.extend({}, defaults, options), url = settings.url, promise = xhr.promise = new Promise(), oldAlways = promise.always;
